...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { description: @discussion.description, project_id: @discussion.project_id, title: @discussion.title }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { description: @discussion.description, project_id: @discussion.project_id, title: @discussion.title }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
